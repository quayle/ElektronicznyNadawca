...
class deklaracjaCelnaType
{
     ...
     * @param string $waluta
     */
    public function __construct($szczegoly, $podarunek, $dokument, $probkaHandlowa, $zwrotTowaru, $towary, $inny, $wyjasnienie, $oplatyPocztowe, $uwagi, $licencja, $swiadectwo, $faktura, $numerReferencyjnyImportera, $numerTelefonuImportera, $waluta)
    {
    ...
    /**
     * @param szczegolyDeklaracjiCelnejType $szczegoly
     * @return \PocztaPolska\ElektronicznyNadawca\deklaracjaCelnaType
     */
    public function setSzczegoly($szczegoly)
    {
      $this->szczegoly = $szczegoly;
      return $this;
    }

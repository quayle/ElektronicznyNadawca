...
class przesylkaPobraniowaType extends przesylkaRejestrowanaType
{
     ...
     * @param masaType $masa
     */
    public function __construct($guid, $pakietGuid, $opakowanieGuid, $opis, $adres, $numerNadania, $posteRestante, $iloscPotwierdzenOdbioru, $kategoria, $gabaryt, $ostroznie, $wartosc, $masa)
    {
     ...
     * @return \PocztaPolska\ElektronicznyNadawca\przesylkaPobraniowaType
     */

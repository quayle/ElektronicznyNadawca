...
class przesylkaPaletowaType extends przesylkaRejestrowanaType
{
     ...
     */
    public function __construct($guid, $pakietGuid, $opakowanieGuid, $opis, $adres, $numerNadania, $paleta, $platnik, $zawartosc, $masa, $dataZaladunku, $dataDostawy, $wartosc, $iloscZwracanychPaletEUR, $zalaczonaFV, $zalaczonyWZ, $zalaczoneInne, $zwracanaFV, $zwracanyWZ, $zwracaneInne, $powiadomienieNadawcy, $powiadomienieOdbiorcy)
    {
     ...
     * @return \PocztaPolska\ElektronicznyNadawca\przesylkaPaletowaType
     */
     ...
     * @return \PocztaPolska\ElektronicznyNadawca\przesylkaPaletowaType
     */
    public function setSubPaleta($subPaleta)
    {

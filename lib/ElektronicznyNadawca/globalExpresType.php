...
class globalExpresType extends przesylkaRejestrowanaType
{
     ...
     */
    public function __construct($guid, $pakietGuid, $opakowanieGuid, $opis, $adres, $numerNadania, $ubezpieczenie, $potwierdzenieDoreczenia, $masa, $posteRestante, $zawartosc, $kategoria, $numerPrzesylkiKlienta)
    {
    ...
    /**
     * @param ubezpieczenieType $ubezpieczenie
     * @return \PocztaPolska\ElektronicznyNadawca\globalExpresType
     */

...
class pocztexKrajowyType extends przesylkaRejestrowanaType
{
     ...
     */
    public function __construct($guid, $pakietGuid, $opakowanieGuid, $opis, $adres, $numerNadania, $posteRestante, $terminRodzaj, $kopertaFirmowa, $masa, $wartosc, $ostroznie, $ponadgabaryt, $uiszczaOplate, $odleglosc, $zawartosc, $sprawdzenieZawartosciPrzesylkiPrzezOdbiorce)
    {
     ...
     * @return \PocztaPolska\ElektronicznyNadawca\pocztexKrajowyType
     */

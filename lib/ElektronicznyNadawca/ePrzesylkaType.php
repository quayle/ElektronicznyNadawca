...
class ePrzesylkaType extends przesylkaRejestrowanaType
{
     ...
     */
    public function __construct($guid, $pakietGuid, $opakowanieGuid, $opis, $adres, $numerNadania, $urzadWydaniaEPrzesylki, $masa, $eSposobPowiadomieniaAdresata, $eSposobPowiadomieniaNadawcy, $eKontaktAdresata, $eKontaktNadawcy, $ostroznie, $wartosc)
    {
    ...
    /**
     * @param urzadWydaniaEPrzesylkiType $urzadWydaniaEPrzesylki
     * @return \PocztaPolska\ElektronicznyNadawca\ePrzesylkaType
     */
